document.addEventListener("DOMContentLoaded", () => {
  ...
  function drawChart(){
    ...
    chartData.forEach((val,i)=>{
      ...
      if(i===0) ctx.moveTo(x,y);
        ...
        const prevX = padding + ((i-1)/(len-1))*w;
        const prevY = canvas.height-padding - ((chartData[i-1]-minVal)/range)*h;
  ...
  function calculateEMA(period=20){
    ...
    return ((ema-chartData[0])/chartData[0])*100;
  }
