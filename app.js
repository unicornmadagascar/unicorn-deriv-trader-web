...
// ===============================================================
// 🧱 Connexion principale sur connectBtn
// ===============================================================
connectBtn.onclick = () => {
  if (ws && ws.readyState === WebSocket.OPEN) {
    ws.close();
  ...
  ws.onmessage = msg => {
    ...
    switch (data.msg_type) {
      ...
      case "sell":
        logHistory("💰 Sell response: " + JSON.stringify(data));
        break;
    }
   };
